...
public class GetInputsResponse extends Response {
	...
	private List<Set<TransactionOutput>> inputList;
	
	public GetInputsResponse(List<Set<TransactionOutput>> inputList) {
		this.inputList = inputList;
	}

	public Request getRequest(Network clientNetwork, Peer peer) throws Exception {
		ResponseHolder.getInstance().setObject(getCorrelationId(), getInputList());
