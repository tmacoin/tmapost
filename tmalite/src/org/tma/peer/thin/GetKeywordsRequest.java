...
public class GetKeywordsRequest extends Request {
	...
	public GetKeywordsRequest(Network clientNetwork, String tmaAddress, String transactionId) {
	...
	public void start() {
		...
		//logger.debug("tmaAddress={}, shardId={}", tmaAddress, shardId);
