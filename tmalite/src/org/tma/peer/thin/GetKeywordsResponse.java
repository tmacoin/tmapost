...
public class GetKeywordsResponse extends Response {
	...
	public GetKeywordsResponse(Keywords keywords) {
		this.keywords = keywords;
	}

	public Request getRequest(Network clientNetwork, Peer peer) throws Exception {
		ResponseHolder.getInstance().setObject(getCorrelationId(), getKeywords());
