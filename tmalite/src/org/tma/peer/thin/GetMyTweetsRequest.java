...
public class GetMyTweetsRequest extends Request {
	...
	private String twitterTmaAddress;
	
	public GetMyTweetsRequest(Network clientNetwork, String twitterTmaAddress) {
		this.clientNetwork = clientNetwork;
		this.twitterTmaAddress = twitterTmaAddress;
	}
	...
	public void start() {
		int shardId = StringUtil.getShard(twitterTmaAddress, clientNetwork.getBootstrapShardingPower());
