...
public class SearchTwitterRequest extends Request {
	...
	public SearchTwitterRequest(Network clientNetwork, String account) {
	...
	public void start() {
		int shardId = StringUtil.getShardForNonTmaAddress(account, clientNetwork.getBootstrapShardingPower());
