...
<html lang="en">
  ...
  <body>
    ...
    <div class="row"> 
      <div class="col-md-2 font-weight-bold">TMA Address:</div>
      <div class="col-md-4">${tmaAddress}</div>
    </div>
    
    <div class="row"> 
      <div class="col-md-2 font-weight-bold">Balance:</div>
      <div class="col-md-4">${balance} coins</div>
    </div>
