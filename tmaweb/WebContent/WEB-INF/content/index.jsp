...
<html lang="en">
  <head>
	...
	<meta name="Description" CONTENT="Unsensored, open source, blockchain based announcement posting. Uncentralized distributed, sensorship free alternative to Yelp, Twitter, Craiglist or eBay">
    <!-- Bootstrap CSS -->
