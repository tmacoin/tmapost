...
<html lang="en">
  ...
  <body>
    ...
    <s:form action="find-posts">
	  <div class="form-group row">
	    <label for="post" class="col-sm-2 col-form-label font-weight-bold">Post:</label>
	    <div class="col-sm-10">
	  ...
	  <div class="form-group row">
	    <label for="keywords" class="col-sm-2 col-form-label font-weight-bold">Keywords:</label>
	    <div class="col-sm-10">
	  ...
	  <div class="form-group row">
	    <div class="col-sm-10">
	      <button type="submit" class="btn btn-dark">Find Posts</button>
	    </div>
	  </div>
	</s:form>
